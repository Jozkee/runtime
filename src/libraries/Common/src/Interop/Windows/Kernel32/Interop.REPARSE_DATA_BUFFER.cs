...
internal static partial class Interop
{
    internal static partial class Kernel32
    {
        ...
        public struct REPARSE_DATA_BUFFER
        {
            ...
            public SymbolicLinkReparseBuffer SymbolicLinkReparseBuffer;//SymbolicLinkData;
            public MountPointReparseBuffer MountPointReparseBuffer;//MountPointData;
            public GenericReparseBuffer GenericReparseBuffer;//GenericData;
